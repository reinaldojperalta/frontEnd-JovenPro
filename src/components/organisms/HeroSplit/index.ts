// components/organisms/HeroSplit/index.ts

// ============================================================================
// HERO SPLIT — Barrel export
// ============================================================================
...
export type {
    ...
    HeroSplitContentAlign,
} from "./HeroSplit.variants";

export { HeroSplitSkeleton } from "./HeroSplitSkeleton";
export type { HeroSplitSkeletonProps } from "./HeroSplitSkeleton";