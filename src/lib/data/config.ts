...
export const testimonials: Testimonial[] = [
    ...
    {
        id: "test-002",
        name: "Tiarej Relojeria",
        role: "@tiarej.relojeria.accesorios",
        avatar: "/images/testimonials/tiarej.webp",
        initials: "TI",
        text: "Con JovenPro, he ampliado los clientes potenciales a través de materiales de difusión en redes y en las ferias presenciales, he podido hacer mejoras...",
        rating: 4,
    },
    {
        id: "test-003",
...
export const heroSplitData: HeroSplitData = {
    ...
    right: {
        ...
        cta: "EXPLORAR TIENDA.",
        href: "#productos",
        image: "/images/hero/emprendedor-mirror.webp",
    },
